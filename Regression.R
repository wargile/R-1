# See also (Andrew Ng's Machine Learning lecture notes): http://cs229.stanford.edu/materials.html
# http://digitheadslabnotebook.blogspot.no/2012/07/linear-regression-by-gradient-descent.html
# http://spin.atomicobject.com/2014/06/24/gradient-descent-linear-regression/ (good Python example!)
# https://www.youtube.com/watch?v=B3vseKmgi8E&feature=youtu.be&t=11m27s
